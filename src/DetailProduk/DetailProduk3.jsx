...
function DetailProduk3({ route, navigation }) {
  ...
  // Daftar ukuran khusus untuk produk ini (sepatu)
  const productSizes = ['41', '42', '43', '44']; //pasangan dari sizes={productSizes}
  ...
  // SLIDER GAMBAR
  const images = [
    require("../../assets/products/prodak_3.png"),
    require("../../assets/products/prodak_2.png"),
    require("../../assets/products/prodak_4.jpg"),
  ];
