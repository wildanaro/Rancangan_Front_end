...
function DetailProduk5({ route, navigation }) {
  ...
  // SLIDER GAMBAR
  const images = [
    require("../../assets/products/jens-hitam.jpg"),
    require("../../assets/products/jens-2.jpg"),
    require("../../assets/products/jens3.jpeg"),
  ];
